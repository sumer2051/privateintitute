...
export const DeviceFrame = () => {
  ...
  return (
    <>
      {/* Status bar */}
      <div className="fixed inset-x-0 top-0 z-[300] h-[var(--ios-status-h,44px)] select-none bg-background text-foreground">
      ...
      {/* Home indicator */}
      <div className="fixed inset-x-0 bottom-0 z-[300] flex h-[var(--ios-home-h,22px)] items-center justify-center bg-background">
