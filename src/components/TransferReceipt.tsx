  ...
  if (isVenmo) {
    ...
    const VRow = ({ label, children }: { label: string; children: ReactNode }) => (
      <div className="mt-3.5">
        <div className="text-[14px] text-neutral-900">{label}</div>
        ...
        <DialogContent data-brand-skin className={`${fittedReceiptShell} border-0 bg-white [&>button]:hidden`}>
          ...
          <div className="flex min-w-0 flex-col overflow-x-hidden overflow-y-hidden bg-white">
            ...
            <div className="flex flex-col items-center px-4 pt-5 text-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-neutral-300 text-[22px] font-semibold text-neutral-700">
                {initials || "•"}
              </div>
              <h1 className="mt-2.5 break-words text-[26px] font-bold leading-tight text-neutral-900">{vName}</h1>
              <div className="mt-2 text-[32px] font-bold text-[#d02a2e]">
                - {amountStr.replace(/^[−-]\s*/, "")}
              </div>
              {feeStr && (
            ...
            <div className="px-4 pt-4">
              ...
              <div className="mt-3.5 h-px bg-neutral-200" />
            </div>
            ...
            <div className="px-4 pb-5">
              ...
              <VRow label="Payment method">
                <div className="flex items-center gap-3">
                  <span className="flex h-8 w-10 shrink-0 items-center justify-center rounded-sm bg-[#1173b1] text-[13px] font-bold text-white">
                    {method.glyph}
                  </span>
              ...
              <VRow label="Transaction details">
                <div className="flex items-center gap-3">
                  ...
                  <span className="flex items-center gap-1 text-[14px] font-semibold text-[#008cff]">
              ...
              <VRow label="Transaction ID">
                <span className="font-mono text-[14px] font-normal text-neutral-800">{reference}</span>
              </VRow>
            </div>
          </div>
          </FitBox>
