  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-[calc(var(--ios-home-h,20px)+16px)] right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-2xl transition-all hover:scale-110",
