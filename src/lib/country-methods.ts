...
export const COUNTRY_METHODS: Record<string, CountryMethod[]> = {
  USD: [
   ...
   { id: "ach",    name: "ACH Transfer", tagline: "Standard US bank transfer", settlement: "1–3 business days", glyph: "A", accent: "from-slate-600 to-slate-800", receiptStyle: "minimal", fields: [{ key: "recipient_name", label: "Recipient Name", required: true, placeholder: "Jane Doe" }, BANK, ROUTING, ACCOUNT] },
