...
const FEE: BankField = { key: "fee", label: "Fee (if any)", placeholder: "e.g. 2.50", inputMode: "decimal", required: false };
...
export const COUNTRY_METHODS: Record<string, CountryMethod[]> = {
  ...
  GBP: [
    { id: "faster_payments", name: "Faster Payments", tagline: "Instant UK transfer",   settlement: "Within minutes",   glyph: "F", accent: "from-rose-600 to-red-700", receiptStyle: "confirmation", fields: [BANK, SORT_CODE, { ...ACCOUNT, label: "Account Number", placeholder: "8 digits" }, { key: "reference", label: "Reference", required: false, placeholder: "e.g. Gym" }, FEE] },
    ...
    { id: "chaps",           name: "CHAPS",           tagline: "Same-day large-value",  settlement: "Same business day", glyph: "C", accent: "from-slate-700 to-slate-900", receiptStyle: "confirmation", fields: [BANK, SORT_CODE, ACCOUNT, { key: "reference", label: "Payment Reference", required: true, placeholder: "e.g. Property purchase" }, FEE] },
