...
export const COUNTRY_METHODS: Record<string, CountryMethod[]> = {
  USD: [
   ...
   { id: "ach",    name: "ACH Transfer", tagline: "Standard US bank transfer", settlement: "1–3 business days", glyph: "A", accent: "from-slate-600 to-slate-800", receiptStyle: "confirmation", fields: [{ key: "recipient_name", label: "Recipient Name", required: true, placeholder: "Jane Doe" }, BANK, ROUTING, ACCOUNT] },
   { id: "wire",   name: "Domestic Wire", tagline: "Same-day US wire",        settlement: "Same business day", glyph: "W", accent: "from-navy-700 to-slate-900", receiptStyle: "formal", fields: [{ key: "recipient_name", label: "Recipient Name", required: true, placeholder: "Jane Doe" }, BANK, ROUTING, ACCOUNT, { key: "bank_address", label: "Bank Address", required: true, placeholder: "Street, City, State" }] },
  ],
  CAD: [
  ...
  GBP: [
    { id: "faster_payments", name: "Faster Payments", tagline: "Instant UK transfer",   settlement: "Within minutes",   glyph: "F", accent: "from-rose-600 to-red-700", receiptStyle: "confirmation", fields: [BANK, SORT_CODE, { ...ACCOUNT, label: "Account Number", placeholder: "8 digits" }, { key: "reference", label: "Reference", required: false, placeholder: "e.g. Gym" }] },
    ...
    { id: "chaps",           name: "CHAPS",           tagline: "Same-day large-value",  settlement: "Same business day", glyph: "C", accent: "from-slate-700 to-slate-900", receiptStyle: "confirmation", fields: [BANK, SORT_CODE, ACCOUNT, { key: "reference", label: "Payment Reference", required: true, placeholder: "e.g. Property purchase" }] },
    { id: "bacs",            name: "BACS",            tagline: "Batch UK payroll-style", settlement: "3 business days", glyph: "B", accent: "from-emerald-700 to-teal-800", receiptStyle: "confirmation", fields: [BANK, SORT_CODE, { ...ACCOUNT, placeholder: "8 digits" }, { key: "reference", label: "Reference", required: false, placeholder: "e.g. Invoice 204" }] },
  ],
  EUR: [
    { id: "sepa",         name: "SEPA Credit Transfer", tagline: "Standard Euro payment", settlement: "Same day – 1 business day", glyph: "S", accent: "from-blue-500 to-cyan-600", receiptStyle: "confirmation", fields: [BANK, IBAN, BIC, { key: "reference", label: "Reference", required: false, placeholder: "e.g. Invoice 204" }] },
    { id: "sepa_instant", name: "SEPA Instant",         tagline: "Within 10 seconds",     settlement: "Seconds (24/7)",           glyph: "⚡", accent: "from-amber-400 to-orange-500", receiptStyle: "confirmation", fields: [BANK, IBAN, BIC, { key: "reference", label: "Reference", required: false, placeholder: "e.g. Rent" }] },
  ...
  INR: [
    ...
    { id: "imps", name: "IMPS", tagline: "24/7 instant transfer",   settlement: "Within seconds",       glyph: "I", accent: "from-green-500 to-emerald-700", receiptStyle: "confirmation", fields: [BANK, ACCOUNT, IFSC] },
    { id: "neft", name: "NEFT", tagline: "Standard batch transfer", settlement: "Same business day",    glyph: "N", accent: "from-sky-600 to-blue-700",     receiptStyle: "confirmation", fields: [BANK, ACCOUNT, IFSC] },
  ...
  NGN: [
    ...
    { id: "nip_ng",   name: "Bank Transfer (NIP)", tagline: "Instant NUBAN transfer", settlement: "Instant", glyph: "N", accent: "from-emerald-700 to-teal-800", receiptStyle: "confirmation", fields: [BANK, { ...ACCOUNT, label: "NUBAN Account Number", placeholder: "10 digits" }] },
  ],
  ZAR: [
  ...
  // Mexico
  MXN: [
    { id: "spei",    name: "SPEI",  tagline: "Instant Mexican transfer", settlement: "Near-instant",     glyph: "S", accent: "from-emerald-600 to-green-700", receiptStyle: "confirmation", fields: [BANK, { key: "clabe", label: "CLABE", inputMode: "numeric", maxLength: 18, required: true, placeholder: "18 digits" }] },
  ...
  CHF: [
    { id: "sic_chf", name: "SIC Transfer", tagline: "Swiss RTGS", settlement: "Same business day", glyph: "S", accent: "from-red-600 to-rose-700", receiptStyle: "confirmation", fields: [BANK, IBAN, BIC] },
